...
- npm 9.0.0 or higher
- Backend API running at `http://localhost:8063`
...
│   │   └── FormSubscriptionSelect.tsx
│   │   ├── UsageRecordList.tsx
│   │   ├── UsageRecordDetail.tsx
│   │   ├── UsageRecordForm.tsx
│   │   └── FormUsageRecordSelect.tsx
...
|--------|--------------|-------|
| Plan | `/api/plans` | `/plans` |
| Subscription | `/api/subscriptions` | `/subscriptions` |
| UsageRecord | `/api/usage-records` | `/usage-records` |
...
|----------|-------------|---------|
| `VITE_API_BASE_URL` | Backend API base URL | `http://localhost:8063` |
| `VITE_API_PATH_PREFIX` | API path prefix | `/api` |
| `VITE_API_TIMEOUT` | API request timeout (ms) | `30000` |
| `VITE_APP_NAME` | Application name | `billing` |
