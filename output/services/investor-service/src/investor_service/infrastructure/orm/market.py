"""Generated Market model for TreasuryOS.

This module defines the Market model using TreasuryOS BaseModel patterns.
"""
...
class Market(BaseModel):
    ...
    _table = "vs_market"
    _description = "Market sector or industry focus category"

    # Primary Key (auto-generated UUID)
    id: str = fields.String(required=False, primary_key=True, default_factory=lambda: str(uuid4()))

    # User-defined Fields
    title: str = fields.String(size=255, required=True, unique=True, help="Market/sector name")
    is_country: str = fields.Boolean(
        required=True, default=False, help="Whether this is a country-based market category"
    )
