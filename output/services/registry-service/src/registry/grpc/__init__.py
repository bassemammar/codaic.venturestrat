...
# Import google protobuf common types first to register them in descriptor pool
# This fixes: "Couldn't build proto file - google/protobuf/timestamp.proto not loaded"
