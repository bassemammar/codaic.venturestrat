...
- npm 9.0.0 or higher
- Backend API running at `http://localhost:8062`
...
│   │   ├── ActivityDetail.tsx
│   │   ├── ActivityForm.tsx
│   │   └── FormActivitySelect.tsx
│   │   ├── PipelineStageList.tsx
│   │   ├── PipelineStageDetail.tsx
│   │   ├── PipelineStageForm.tsx
│   │   └── FormPipelineStageSelect.tsx
│   │   ├── ShortlistList.tsx
│   │   ├── ShortlistDetail.tsx
│   │   ├── ShortlistForm.tsx
│   │   └── FormShortlistSelect.tsx
│   │   ├── ShortlistTagList.tsx
│   │   ├── ShortlistTagDetail.tsx
│   │   ├── ShortlistTagForm.tsx
│   │   └── FormShortlistTagSelect.tsx
│   │   ├── TagList.tsx
│   │   ├── TagDetail.tsx
│   │   ├── TagForm.tsx
│   │   └── FormTagSelect.tsx
...
│   │   ├── shortlistService.ts
│   │   ├── shortlistTagService.ts
│   │   ├── tagService.ts
│   ├── types/              # TypeScript type definitions
│   │   ├── activity.types.ts
│   │   ├── pipelineStage.types.ts
│   │   ├── shortlist.types.ts
│   │   ├── shortlistTag.types.ts
│   │   ├── tag.types.ts
│   ├── pages/              # Route page components
│   │   ├── Home.tsx
│   │   ├── ActivityPage.tsx
│   │   ├── PipelineStagePage.tsx
│   │   ├── ShortlistPage.tsx
│   │   ├── ShortlistTagPage.tsx
│   │   ├── TagPage.tsx
│   │   └── NotFound.tsx
...
|--------|--------------|-------|
| Activity | `/api/activities` | `/activities` |
| PipelineStage | `/api/pipeline-stages` | `/pipeline-stages` |
| Shortlist | `/api/shortlists` | `/shortlists` |
| ShortlistTag | `/api/shortlist-tags` | `/shortlist-tags` |
| Tag | `/api/tags` | `/tags` |
...
|----------|-------------|---------|
| `VITE_API_BASE_URL` | Backend API base URL | `http://localhost:8062` |
| `VITE_API_PATH_PREFIX` | API path prefix | `/api` |
| `VITE_API_TIMEOUT` | API request timeout (ms) | `30000` |
| `VITE_APP_NAME` | Application name | `crm` |
