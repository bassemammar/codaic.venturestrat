"""Configuration management for Outreach Service."""
...
class Settings(BaseSettings):
    ...
    # Service info
    service_name: str = "outreach-service"
    ...
    kafka_topic_prefix: str = "outreach_service"

    # Consumer settings
    lifecycle_poll_interval: int = 60
    ...
    google_redirect_uri: str = "http://localhost:5177/settings/oauth/google/callback"
    microsoft_client_id: str = ""
    microsoft_client_secret: str = ""
    microsoft_redirect_uri: str = "http://localhost:5177/settings/oauth/microsoft/callback"
