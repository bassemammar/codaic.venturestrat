...
- npm 9.0.0 or higher
- Backend API running at `http://localhost:8061`
...
│   │   ├── EmailAccountDetail.tsx
│   │   ├── EmailAccountForm.tsx
│   │   └── FormEmailAccountSelect.tsx
│   │   ├── EmailTemplateList.tsx
│   │   ├── EmailTemplateDetail.tsx
│   │   ├── EmailTemplateForm.tsx
│   │   └── FormEmailTemplateSelect.tsx
│   │   ├── LifecycleEmailList.tsx
│   │   ├── LifecycleEmailDetail.tsx
│   │   ├── LifecycleEmailForm.tsx
│   │   └── FormLifecycleEmailSelect.tsx
│   │   ├── MessageList.tsx
│   │   ├── MessageDetail.tsx
│   │   ├── MessageForm.tsx
│   │   └── FormMessageSelect.tsx
│   ├── hooks/              # Custom React hooks
│   │   ├── useEmailAccounts.ts
│   │   ├── useEmailTemplates.ts
│   │   ├── useLifecycleEmails.ts
│   │   ├── useMessages.ts
│   │   └── queryKeys.ts    # React Query cache keys
│   ├── services/           # API service functions
│   │   ├── emailAccountService.ts
│   │   ├── emailTemplateService.ts
│   │   ├── lifecycleEmailService.ts
│   │   ├── messageService.ts
│   ├── types/              # TypeScript type definitions
│   │   ├── emailAccount.types.ts
│   │   ├── emailTemplate.types.ts
│   │   ├── lifecycleEmail.types.ts
│   │   ├── message.types.ts
│   ├── pages/              # Route page components
│   │   ├── Home.tsx
│   │   ├── EmailAccountPage.tsx
│   │   ├── EmailTemplatePage.tsx
│   │   ├── LifecycleEmailPage.tsx
│   │   ├── MessagePage.tsx
│   │   └── NotFound.tsx
...
|--------|--------------|-------|
| EmailAccount | `/api/email-accounts` | `/email-accounts` |
| EmailTemplate | `/api/email-templates` | `/email-templates` |
| LifecycleEmail | `/api/lifecycle-emails` | `/lifecycle-emails` |
| Message | `/api/messages` | `/messages` |
...
```tsx
import { useCreateEmailAccount, useUpdateEmailAccount, useDeleteEmailAccount } from '../hooks/useEmailAccounts';
...
|----------|-------------|---------|
| `VITE_API_BASE_URL` | Backend API base URL | `http://localhost:8061` |
| `VITE_API_PATH_PREFIX` | API path prefix | `/api` |
| `VITE_API_TIMEOUT` | API request timeout (ms) | `30000` |
| `VITE_APP_NAME` | Application name | `outreach` |
